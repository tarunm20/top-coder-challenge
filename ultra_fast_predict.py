#!/usr/bin/env python3
"""
Ultra-fast prediction script for reimbursement calculation.
Optimized for maximum speed when running thousands of predictions.
"""
...
def load_model():
    ...
    global _model
    if _model is None:
        with open('ultra_fast_model.pkl', 'rb') as f:
...
def main():
    if len(sys.argv) != 4:
        print("Usage: python3 ultra_fast_predict.py <days> <miles> <receipts>")
        sys.exit(1)
